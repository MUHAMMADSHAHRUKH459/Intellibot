          ...
          <div className="flex flex-wrap -m-4">
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
                ...
                <h2 className="text-lg text-white font-medium title-font mb-4">
                  Fully Functinal E-commerce Website
                </h2>
            ...
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-base">
                Shop.com Highlights
                Sanity CMS Integration: Enabled dynamic product management and real-time updates.
                Add-to-Cart: Built a seamless cart system with live updates.
                Dynamic Routing: Used Next.js for engaging product pages.
                Responsive UI: Designed a mobile-friendly interface with Tailwind CSS.
                </p>
              </div>
            </div>
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-base">
                Dynamic Routing: Seamless blog navigation with no reloads.
                seamless experience for users to explore various blogs without any page reloads. 
                Responsive Design: Adapts to all screen sizes.
                Real-Time Updates: Instantly publish blogs via Sanity.io.
                User-Friendly UI: Clean design for effortless browsing.
                SEO Optimized: Enhanced visibility and rankings.
                </p>
              </div>
            </div>
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
                ...
                Describe their symptoms to receive preliminary guidance
                Built with HTML and Tailwind CSS, this site is fully responsive and optimized to provide a seamless experience across all devices. From concept to completion, this project is a step towards bridging the gap between technology and healthcare.
                </p>
              </div>
            </div>
          </div>
