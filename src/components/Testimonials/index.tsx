...
const testimonialData: Testimonial[] = [
  {
    id: 1,
    name: "Muhammad Ali",
    designation: "UnionTech",
    content:
      "Intellibot Creation transformed our website with a user-friendly design that truly reflects our brand. Their expertise in web development is unmatched.",
    ...
    <section className="dark:bg-bg-color-dark bg-gray-light relative z-10 py-16 md:py-20 lg:py-28">
      <div className="container">
        <SectionTitle
         ...
         paragraph="Discover how our clients have benefited from our innovative AI and chatbot solutions, transforming their businesses and enhancing customer experiences."
         center
        />
