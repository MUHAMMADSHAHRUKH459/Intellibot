          ...
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            ...
            >
              <h2 className="mb-3 text-2xl font-bold text-black dark:text-white sm:text-3xl lg:text-2xl xl:text-3xl">
                Get in Touch with Intellibot Creation
              </h2>
              <p className="mb-12 text-base font-medium text-body-color">
                We are here to assist you with AI-powered chatbots and web development solutions. Drop us a message, and our team will respond promptly via email.
              </p>
              <form 
               action="https://formspree.io/f/movjvwrw"
               method="POST"
              >
                <div className="-mx-4 flex flex-wrap">
